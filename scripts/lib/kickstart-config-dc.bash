...
part /tmp      --fstype ext3 --size=220000  --grow --ondrive=sda
part /var      --fstype ext3 --size=200000  --grow --ondrive=sdb
part /opt      --fstype ext3 --size=100000  --grow --ondrive=sdb
part /usr/hdp  --fstype ext3 --size=100000  --grow --ondrive=sdb
part /         --fstype ext3 --size=400000  --grow --ondrive=sdb
part /data     --fstype ext3 --size=1100000 --grow --ondrive=sdb
part /grid/1   --fstype ext3 --size=1500000 --grow --ondrive=sdc
part /grid/2   --fstype ext3 --size=1500000 --grow --ondrive=sdd
